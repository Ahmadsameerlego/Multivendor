    ...
    <div class="container">
      <div class="container p-0 px-md-3">
        <div class="home-footer d-flex flex-wrap">
          <div
            class="section footer-links w-100 py-6 fs-13 d-flex flex_between border-bottom"
          >
            <a
              href="#"
              class="btn btn-link o-5 f-14 pt-4 pl-5 mt-3"
              target="_blank"
              rel="noreferrer"
              >وظائف</a
            >
            ...
            <a
              href="#"
              class="btn btn-link o-5 f-14 pt-4 pl-5 mt-3 text-uppercase"
              target="_self"
              rel="noreferrer"
              >خصوصية الموقع</a
            >
                ...
                <div class="accordion accordion-flush" id="restaurantAccordion">
                  <div class="accordion-item">
                    ...
                    >
                      ...
                      >
                        <a href="-zamalek" class="btn btn-link pl-5 pt-3"
                          >طابون</a
                        >
                        <a
                          href="-africa-city-stars"
                          class="btn btn-link pl-5 pt-3"
                          >بلانت أفريكا</a
                        >
                        <a href="-yuan-maadi" class="btn btn-link pl-5 pt-3"
                          >لان يوان - المعادى</a
                        >
                        <a href="-heliopolis" class="btn btn-link pl-5 pt-3"
                          >حضرموت</a
                        >
                        <a
                          href="-food-heliopolis"
                          class="btn btn-link pl-5 pt-3"
                          >ويلد هاوس باي كريزي فوود</a
                        >
                        <a href="/ar" class="btn btn-link pl-5 pt-3 more-link"
                          >مطاعم أخرى</a
                        >
                      </div>
                    </div>
                ...
                <div class="accordion accordion-flush" id="aboutAccordion">
                  <div class="accordion-item">
                    ...
                    >
                      ...
                      >
                        <a
                          href="/ar/egypt/about-us"
                          class="btn btn-link pl-5 pt-3"
                          >من نحن</a
                        >
                        <a
                          href="/ar/egypt/contact-us"
                          class="btn btn-link pl-5 pt-3"
                          >إتصل بنا</a
                        >
                        <a
                          href="/ar/egypt/privacy"
                          class="btn btn-link pl-5 pt-3"
                          >سياسة الخصوصية</a
                        >
                        <a href="/ar/egypt/terms" class="btn btn-link pl-5 pt-3"
                          >الشروط و الأحكام</a
                        >
                        <a href="/ar/egypt/faq" class="btn btn-link pl-5 pt-3"
                          >أسئلة متكررة</a
                        >
                        <a
                          href="/ar/egypt/sitemap"
                          class="btn btn-link pl-5 pt-3 more-link"
                          >خريطة الموقع</a
                        >
                      </div>
                    </div>
          ...
          <div class="flex_center w-100 pb-3">
            <div class="pt-4 flex_center">
              <h4 class="whiteColor fs-6 o-5 text-center flex_center">
                جميع الحقوق محفوظة 2024 @ coffeekies
              </h4>
            </div>
          </div>
        </div>
